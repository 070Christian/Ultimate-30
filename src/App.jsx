    ...
    <Layout>
      <main>
        ...
        <ol className="benefits-list">
          ...
          <li className="">Progress strength in key muscle groups</li>
          <li>Learn more about gym, training and technique</li>
          <li>Track your progress along the way</li>
        </ol>
        <h3>The Rules</h3>
        <p>For the best results, you <b>MUST</b> follow these 3 simple rules:</p>
        <ul className="rules-list">
          <div className="rule-item">
            <p ><b>Rest</b> </p>
            <p>Ensure that you are getting proper sleep and taking rest days</p>
          </div>
          <div className="rule-item">
            <p ><b>Reps</b> </p>
